...
class FeaturedPerson extends BlockBase implements BlockPluginInterface {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['featured_person_title'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Featured Person Title'),
      '#description' => $this->t('Text to be displayed with the person.'),
      '#default_value' => isset($config['featured_person_title']) ? $config['featured_person_title'] : '',
      '#required' => TRUE,
    ];

    $form['featured_person_node'] = [
      ...
      '#default_value' => isset($config['featured_person_node']) ? Node::load($config['featured_person_node']) : '',
      '#required' => TRUE,
    ];
